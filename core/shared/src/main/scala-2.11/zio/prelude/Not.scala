...
object Not {
   ...
   * Together with the instance defined below this will cause implicit search
   * to fail due to ambiguous implicits, preventing an instance of `Not[A]`
   * from being in implicit scope when an instance of `A` is in implicit scope.
   */
  ...
  /**
   * Derives a `Not[A]` instance when an instance of `A` is in implicit scope.
   * Together with the instance defined above this will cause implicit search
   * to fail due to ambiguous implicits, preventing an instance of `Not[A]`
   * from being in implicit scope when an instance of `A` is in implicit scope.
   */
