  ...
  given FromExpr[Assertion.Regex] with {
    def unapply(assertion: Expr[Assertion.Regex])(using Quotes): Option[Assertion.Regex] = {
      ...
      assertion match {
        ...
        case '{ Assertion.Regex.anyCharOf(${Expr(first)}, ${Expr(second)}) }                    => Some(Assertion.Regex.anyCharOf(first, second))
        case '{ Assertion.Regex.anyCharOf(${Expr(first)}, ${Expr(second)}, ${Expr(rest)}) }     => Some(Assertion.Regex.anyCharOf(first, second, rest))
        case '{ Assertion.Regex.anyRegexOf(${Expr(first)}, ${Expr(second)}) }                   => Some(Assertion.Regex.anyRegexOf(first, second))
        case '{ Assertion.Regex.anyRegexOf(${Expr(first)}, ${Expr(second)}, ${Expr(rest)}) }    => Some(Assertion.Regex.anyRegexOf(first, second, rest))
        case '{ Assertion.Regex.notAnyCharOf(${Expr(first)}, ${Expr(second)}) }                 => Some(Assertion.Regex.notAnyCharOf(first, second))
        case '{ Assertion.Regex.notAnyCharOf(${Expr(first)}, ${Expr(second)}, ${Expr(rest)}) }  => Some(Assertion.Regex.notAnyCharOf(first, second, rest))
        case '{ Assertion.Regex.notAnyRegexOf(${Expr(first)}, ${Expr(second)}) }                => Some(Assertion.Regex.notAnyRegexOf(first, second))
        case '{ Assertion.Regex.notAnyRegexOf(${Expr(first)}, ${Expr(second)}, ${Expr(rest)}) } => Some(Assertion.Regex.notAnyRegexOf(first, second, rest))
