...
import zio.prelude.Refinement.Regex.*
...
object NewtypeSpecTypes {
  ...
  object Password extends Newtype[String] {
    ...
    override inline def refinement =
      (Refinement.matches(literal("a").+ ~ anyChar.between(1, 3) ~ literal("oh").*))
  }
